defmodule PhxSaasWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxSaasWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxSaasWeb.Gettext, "errors", msg, opts)
    end
  end
