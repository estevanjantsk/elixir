...
config :ex_mon, ExMonWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "0jbqFI2dE3THRhTqeh/2F++oiDDDPFAKNexR3nLmb1k+Nop62AIcXikoba89jvHN",
  render_errors: [view: ExMonWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: ExMon.PubSub,
  live_view: [signing_salt: "hmqUXsfL"]
...
config :ex_mon, ExMonWeb.Auth.Guardian,
  issuer: "ex_mon",
  secret_key: "vco8oenCmCYvVmOVjiKX3KOl/Y7ExT56YvBXKX1DLAAJmAui/HYty0smngKC0Dpo"
